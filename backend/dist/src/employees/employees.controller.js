...
let EmployeesController = class EmployeesController {
    ...
    findAll(req, queryStoreId) {
        const storeId = req.user.role === client_1.Role.SUPER_ADMIN && queryStoreId ? queryStoreId : req.user.storeId;
...
__decorate([
    (0, common_1.Get)('login-list/:storeId'),
    (0, swagger_1.ApiOperation)({ summary: 'Public: Get active employees for login dropdown' }),
    __param(0, (0, common_1.Param)('storeId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], EmployeesController.prototype, "getLoginList", null);
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], EmployeesController.prototype, "resetPin", null);
__decorate([
    (0, swagger_1.ApiBearerAuth)(),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.Role.STORE_ADMIN),
