...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  Future<void> _confirmAndShare() async {
    ...
    try {
      ...
      // 2. Output PDF Local
      final pdfFile = await InvoicePdfGenerator.generateInvoicePdf(formattedInvoiceData, storeData);

      // 3. Trigger Share Plus
      final text = "Thank you for shopping at ${storeData['name']}!\n"
          "Your bill: ₹${cart.grandTotal}\n"
          "View invoice: bills.billpush.com/v/${invoiceData['billing_id']}";
